...
public enum KnockPVPLab { // endpoint: /experiment/ [params]
    ...
    GET_ROLLING_TOP("https://api.greev.eu/v2/stats/knockpvplab/rolling/%s/%s?startTimestamp=%s&endTimestamp=%s"),
    GET_ROLLING_PLAYER("https://api.greev.eu/v2/stats/knockpvplab/rolling/%s?startTimestamp=%s&endTimestamp=%s");
